...
export default function RegistrationLoading() {
  ...
  const nextRoute = location.state?.redirectTo ?? "/auth/register";
  ...
  return (
    <div className="relative min-h-dvh w-full bg-white overflow-hidden flex items-center justify-center">
