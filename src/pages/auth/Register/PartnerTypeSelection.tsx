...
const PartnerTypeSelection = () => {
  ...
  return (
    <AuthContainer padded={false}>
      <div className="relative min-h-screen overflow-hidden px-6 py-8 flex flex-col bg-[#2DB654]">
        {/* Decorative Car */}
        <img
          src={partnerCar}
          alt=""
          className="absolute top-0 right-0 w-36 md:w-44 pointer-events-none select-none"
        />
        ...
        <div className="relative z-10 mt-8">
          <h1
            className="header-font text-white font-black leading-none max-w-[440px]"
            style={{
          ...
          <p className="mt-4 text-white text-sm opacity-90">Choose a partner type.</p>
        </div>

        {/* Cards */}
        <div className="relative z-10 flex-1 flex flex-col justify-center gap-4 mt-20">
          <SelectionCard
            image={partnerImage}
            ...
            arrowColor="#081E19"
            onClick={() => navigate(ROUTES.INDIVIDUAL_REGISTER)}
          />
          ...
          <SelectionCard
            ...
            arrowBackground="#FFFFFF"
            arrowColor="#081E19"
            onClick={() => navigate(ROUTES.ENTERPRISE_REGISTER)}
          />
        </div>

        {/* Footer */}
        <div className="relative z-10 text-center text-white text-sm pb-2">
          Already registered?
          <Link to={ROUTES.LOGIN} className="ml-2 font-semibold underline">
            Log In
          </Link>
        </div>
      </div>
