...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // code and confirmPassword are both required by the backend — code
      // comes from the verified OTP step (see OTPVerification.tsx, which
      // now forwards it here via location.state).
  ...
  return (
    <AuthContainer>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-10">
        ...
        <Button type="submit" variant="dark" loading={loading} disabled={!passwordsMatch || loading}>
          Reset Password
        </Button>
      </form>
    </AuthContainer>
