...
const Onboarding = () => {
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col py-5">
      <ProgressBar current={currentSlide} total={onboardingData.length} />

      <div className="flex justify-center">
        <img src={carImage} alt="Vehicle" className="w-full max-w-[670px]" />
      </div>
      <div className="px-5">
        <div
          key={currentSlide}
        ...
        <div className="pb-4 space-y-6">
          <Button onClick={() => navigate(ROUTES.REGISTRATION_LOADING)}>Get Started</Button>
        </div>

        <AuthFooter text="Already registered?" linkText="Log in" to={ROUTES.LOGIN} />
      </div>
    </main>
  );
};
